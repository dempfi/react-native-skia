...
const ParagraphOutputs = BUILD_WITH_PARAGRAPH ? ['libskparagraph.a', 'libskunicode.a'] : []
...
export const configurations: Configuration = {
  android: {
    ...
    outputNames: ['libskia.a', 'libskshaper.a', 'libsvg.a', 'libskottie.a', 'libsksg.a', ...ParagraphOutputs],
  },
  ios: {
    targets: {
      'arm64-iphoneos': {
